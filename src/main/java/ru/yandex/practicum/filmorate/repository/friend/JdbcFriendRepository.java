...
public class JdbcFriendRepository implements FriendRepository {
    ...
    public void addFriend(Long userId, Long friendId) {
        if (hasFriendship(userId, friendId)) {
            throw new DuplicateKeyException("Дружба уже существует");
        }

        boolean hasReverseRequest = checkFriendshipStatus(friendId, userId, false);
